...
<body>
    <div class="container">      
        ...
        <div class="row">
            <div class="col-sm-offset-2 col-md-offset-2 col-lg-offset-3 col-xs-12 col-sm-8 col-md-8 col-lg-6">
                <div class="input-group">
                    ...
                    <input type="number" name="total_charged" class="form-control" placeholder="Total" value="<?= $total_charged; ?>" step="0.01">
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="number" name="number_people" class="form-control" placeholder="Numer of People" value="<?= $number_people; ?>">
                </div>
                <br>
                <div class="input-group">
        ...
        <div class="row">
            <p class="text-center">
                <br><label class="checkbox-inline"><input type="checkbox" name="round_up" value="yes" <?= $round_up_checked; ?> >Round Up</label>
